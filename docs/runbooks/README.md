...
* 🧠 [**Proxmox GEEKOM — VM Windows**](./proxmox-geekom-vm-windows.md) — Configuração de VM e rede no Proxmox VE.
* 📁 [**Servidor de Arquivos Proxmox**](./servidor-arquivos-proxmox.md) — Gestão de armazenamento e compartilhamentos.
